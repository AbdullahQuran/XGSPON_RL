...
def make_grant_packet(myClock,id, dest_node, src_node, bwm, payload):
    """Creates a network packet
    """
    pkt = {}
    pkt[Globals.TIME_STAMP] = myClock
    pkt[Globals.ID] = id
...
def make_report_packet(myClock, id, dest_node, src_node, tcon_length, onuId, payload):
    """Creates a network packet
    """
    pkt = {}
    pkt[Globals.TIME_STAMP] = myClock
...
def make_payload_packet(myClock, id, dest_node, src_node, onuId, payload,tcon_id):
    """Creates a network packet
    """
    pkt = {}
    pkt[Globals.TIME_STAMP] = myClock
