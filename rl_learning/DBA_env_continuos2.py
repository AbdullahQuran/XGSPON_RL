...
class env_dba(gym.Env):
    ...
    def normalizeState(self,state):
        ...
        for onu in self.onu1_array:
            id = int(onu.name)
            if (state[0][id-1] < Globals.OBSERVATION_MIN):
                state[0][id-1] = Globals.OBSERVATION_MIN
            if (state[0][id-1] > Globals.OBSERVATION_MAX):
                state[0][id-1] = Globals.OBSERVATION_MAX
            if (state[1][id-1] < Globals.OBSERVATION_MIN):
                state[1][id-1] = Globals.OBSERVATION_MIN
            if (state[1][id-1] > Globals.OBSERVATION_MAX):
                state[1][id-1] = Globals.OBSERVATION_MAX
            
            tmpState[0][id-1] = self.state[0][id-1] / Globals.OBSERVATION_MAX
            tmpState[1][id-1] = self.state[1][id-1] / Globals.OBSERVATION_MAX
